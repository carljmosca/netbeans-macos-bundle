...
NETBEANS_URI=${NETBEANS_URI:-http://mirrors.ocf.berkeley.edu/apache/incubator/netbeans/incubating-netbeans/incubating-11.0/incubating-netbeans-11.0-bin.zip}
